# -*- coding: utf-8 -*-
# 1) Refazer as questões da prova do Grau A, adicionando uma classe Ser Vivo, que será a classe base
# tanto para a classe Animal como a Vegetal. 
...
# Restante do código da correção sem as classes animal e vegetal
